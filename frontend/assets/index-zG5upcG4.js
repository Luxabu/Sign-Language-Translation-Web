...
function Nr(e, t, n, r, l) {
  ...
  if (((i = 0), (r = r === "" ? "." : r + ":"), Ui(e)))
    ...
    for (e = s.call(e), u = 0; !(o = e.next()).done; )
      ((o = o.value), (s = r + El(o, u++)), (i += Nr(o, t, n, s, l)));
  else if (o === "object")
    throw (
      (t = String(e)),
      Error(
...
U.StrictMode = sc;
U.Suspense = pc;
U.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Sc;
U.act = ns;
 ...
 */ (function (e) {
  ...
  function r(_) {
    ...
    if (R !== T) {
      _[0] = R;
      e: for (var H = 0, X = _.length, Ut = X >>> 1; H < Ut; ) {
        var Ke = 2 * (H + 1) - 1,
          mn = _[Ke],
          Et = Ke + 1,
          ir = _[Et];
        if (0 > l(mn, R))
          Et < X && 0 > l(ir, mn)
            ? ((_[H] = ir), (_[Et] = R), (H = Et))
            : ((_[H] = mn), (_[Ke] = R), (H = Ke));
        else if (Et < X && 0 > l(ir, R)) ((_[H] = ir), (_[Et] = R), (H = Et));
        else break e;
      }
    }
    return T;
  ...
  function y(_) {
    if (((x = !1), d(_), !k))
      if (n(s) !== null) ((k = !0), M(N));
        ...
        var T = n(c);
        T !== null && F(y, T.startTime - _);
      }
  }
  function N(_, T) {
    ((k = !1), x && ((x = !1), f(g), (g = -1)), (E = !0));
    var R = p;
    try {
      for (
        d(T), m = n(s);
      ...
      if (m !== null) var Ut = !0;
        ...
        var Ke = n(c);
        (Ke !== null && F(y, Ke.startTime - T), (Ut = !1));
      }
      return Ut;
    } finally {
      ((m = null), (p = R), (E = !1));
      ...
      return (
        ...
        R > H
          ? ((_.sortIndex = R),
            ...
            n(s) === null &&
              _ === n(c) &&
              (x ? (f(g), (g = -1)) : (x = !0), F(y, R - H)))
          : ((_.sortIndex = X), t(s, _), k || E || ((k = !0), M(N))),
        _
      );
    }),
...
function ln(e, t) {
  for (Un[e] = t, e = 0; e < t.length; e++) us.add(t[e]);
}
var qe = !(
    typeof window > "u" ||
...
var nt = Pc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Ss() {
  if (bt) {
    var e = bt,
      t = en;
    if (((en = bt = null), Yi(e), t)) for (e = 0; e < t.length; e++) Yi(t[e]);
  }
}
function ks(e, t) {
  return e(t);
...
function $c(e, t, n, r, l, o, i, u, s) {
  ((zn = !1), (Ur = null), Uc.apply(Ac, arguments));
}
function Bc(e, t, n, r, l, o, i, u, s) {
  if (($c.apply(this, arguments), zn)) {
    if (zn) {
      var c = Ur;
      ((zn = !1), (Ur = null));
...
var js = Ce.unstable_scheduleCallback,
  Gi = Ce.unstable_cancelCallback,
  Hc = Ce.unstable_shouldYield,
  Wc = Ce.unstable_requestPaint,
  b = Ce.unstable_now,
  Qc = Ce.unstable_getCurrentPriorityLevel,
  ei = Ce.unstable_ImmediatePriority,
  Ps = Ce.unstable_UserBlockingPriority,
  $r = Ce.unstable_NormalPriority,
  Kc = Ce.unstable_LowPriority,
  Ts = Ce.unstable_IdlePriority,
  sl = null,
  We = null;
function Yc(e) {
...
var De = Math.clz32 ? Math.clz32 : Zc,
  Xc = Math.log,
  Gc = Math.LN2;
function Zc(e) {
...
function jr(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return ((t = lr(n)), t !== null && ni(t), (e.blockedOn = n), !1);
    t.shift();
  }
  return !0;
}
...
function wn(e, t) {
  e.blockedOn === t &&
    ...
    ho ||
      ((ho = !0),
      Ce.unstable_scheduleCallback(Ce.unstable_NormalPriority, nf)));
}
function Hn(e) {
  function t(l) {
    return wn(l, e);
  ...
  for (; 0 < it.length && ((n = it[0]), n.blockedOn === null); )
    (Is(n), n.blockedOn === null && it.shift());
}
...
function ri(e, t, n, r) {
  if (Vr) {
    var l = mo(e, t, n, r);
    if (l === null) (Ul(e, t, r, Hr, n), Zi(e, r));
    else if (tf(l, e, t, n, r)) r.stopPropagation();
    else if ((Zi(e, r), t & 4 && -1 < ef.indexOf(e))) {
      for (; l !== null; ) {
        var o = lr(l);
        if (
          (o !== null && Ls(o),
          (o = mo(e, t, n, r)),
          o === null && Ul(e, t, r, Hr, n),
          o === l)
        )
          break;
        l = o;
...
var Hr = null;
function mo(e, t, n, r) {
  if (((Hr = null), (e = bo(r)), (e = _t(e)), e !== null))
...
var pn = {
  ...
  al = J({}, rr, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== Sn &&
            (Sn && e.type === "mousemove"
              ? ((Tl = e.screenX - Sn.screenX), (zl = e.screenY - Sn.screenY))
              : (zl = Tl = 0),
            (Sn = e)),
          Tl);
    },
  ...
  bi = _e(al),
  uf = J({}, al, { dataTransfer: 0 }),
  sf = _e(uf),
  af = J({}, rr, { relatedTarget: 0 }),
  Rl = _e(af),
  cf = J({}, pn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  ff = _e(cf),
  df = J({}, pn, {
...
var wf = J({}, rr, {
  ...
  Ef = _e(xf),
  Cf = J({}, pn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Nf = _e(Cf),
  _f = J({}, al, {
    deltaX: function (e) {
...
var Tf = qe && "TextEvent" in window && !Rn,
  As = qe && (!ui || (Rn && 8 < Rn && 11 >= Rn)),
  nu = " ",
  ru = !1;
function $s(e, t) {
  switch (e) {
...
function iu() {
  Ln && (Ln.detachEvent("onpropertychange", Ws), (Wn = Ln = null));
}
function Ws(e) {
  if (e.propertyName === "value" && cl(Wn)) {
    var t = [];
    (Vs(t, Wn, e, bo(e)), Es(Mf, t));
  }
}
function Ff(e, t, n) {
  e === "focusin"
    ? (iu(), (Ln = t), (Wn = n), Ln.attachEvent("onpropertychange", Ws))
    : e === "focusout" && iu();
}
function If(e) {
...
var Ae = typeof Object.is == "function" ? Object.is : Af;
function Qn(e, t) {
  if (Ae(e, t)) return !0;
  ...
  for (r = 0; r < n.length; r++) {
    var l = n[r];
    if (!Zl.call(t, l) || !Ae(e[l], t[l])) return !1;
  }
  return !0;
}
function uu(e) {
...
St(Xs, "onAnimationEnd");
St(Gs, "onAnimationIteration");
St(Zs, "onAnimationStart");
St("dblclick", "onDoubleClick");
St("focusin", "onFocus");
St("focusout", "onBlur");
St(Js, "onTransitionEnd");
...
var jn =
  ...
  Wf = new Set("cancel close invalid load scroll toggle".split(" ").concat(jn));
function fu(e, t, n) {
...
function Kn(e) {
  if (!e[vr]) {
    ...
    t === null || t[vr] || ((t[vr] = !0), Dl("selectionchange", !1, t));
  }
}
function ea(e, t, n, r) {
  switch (Ds(t)) {
  ...
  Es(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              y !== null &&
              ((d = y),
              f !== null && ((y = $n(a, f)), y != null && x.push(Yn(a, y, d)))),
            I)
          )
            break;
          a = a.return;
        ...
        0 < x.length &&
          ((p = new E(p, k, null, n, v)), m.push({ event: p, listeners: x }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (I = E == null ? p : Qt(E)),
            (d = k == null ? p : Qt(k)),
            (p = new x(y, a + "leave", E, n, v)),
            (p.target = I),
            (p.relatedTarget = d),
            (y = null),
            _t(v) === c &&
              ((x = new x(f, a + "enter", k, n, v)),
              (x.target = d),
              (x.relatedTarget = I),
              (y = x)),
            (I = y),
            ...
            t: {
              for (x = E, f = k, a = 0, d = x; d; d = At(d)) a++;
      ...
      if (ui)
        ...
        Vt
          ? $s(e, n) && (g = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (g = "onCompositionStart");
      (g &&
        (As &&
          n.locale !== "ko" &&
          (Vt || g !== "onCompositionStart"
            ? g === "onCompositionEnd" && Vt && (w = Us())
            : ((st = v),
              (li = "value" in st ? st.value : st.textContent),
              (Vt = !0))),
        (C = Wr(c, g)),
        0 < C.length &&
          ((g = new eu(g, e, null, n, v)),
          m.push({ event: g, listeners: C }),
          w ? (g.data = w) : ((w = Bs(n)), w !== null && (g.data = w)))),
        (w = Tf ? zf(e, n) : Rf(e, n)) &&
...
function du(e, t, n, r, l) {
  for (var o = t._reactName, i = []; n !== null && n !== r; ) {
    ...
    (u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = $n(n, o)), s != null && i.unshift(Yn(n, s, u)))
        : l || ((s = $n(n, o)), s != null && i.push(Yn(n, s, u)))),
      (n = n.return));
  }
...
function K(e) {
  0 > Kt || ((e.current = Eo[Kt]), (Eo[Kt] = null), Kt--);
}
function W(e, t) {
  (Kt++, (Eo[Kt] = e.current), (e.current = t));
}
var wt = {},
  fe = kt(wt),
  ge = kt(!1),
...
function ta(e, t, n) {
  ...
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var l in r) if (!(l in t)) throw Error(S(108, Oc(e) || "Unknown", l));
  return J({}, n, r);
}
function Yr(e) {
  return (
...
function xt() {
  if (!$l && Xe !== null) {
    ...
    try {
      ...
      throw (Xe !== null && (Xe = Xe.slice(e + 1)), js(ei, xt), l);
    } finally {
      ((V = t), ($l = !1));
    }
  }
...
function ra(e, t, n) {
  ((je[Pe++] = Ge), (je[Pe++] = Ze), (je[Pe++] = Lt), (Lt = e));
  var r = Ge;
  e = Ze;
  var l = 32 - De(r) - 1;
  ((r &= ~(1 << l)), (n += 1));
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Lt !== null ? { id: Ge, overflow: Ze } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function gr(e) {
  ...
  if (
    ...
    if (Co(e)) throw (oa(), Error(S(418)));
    for (; t; ) (la(e, t), (t = pt(t.nextSibling)));
  }
  if ((wu(e), e.tag === 13)) {
...
var bf = nt.ReactCurrentBatchConfig;
function kn(e, t, n) {
  if (
...
function ia(e) {
      ...
      : a !== null &&
          (a.elementType === N ||
            (typeof N == "object" &&
              ...
              N.$$typeof === lt &&
              Su(N) === a.type))
        ? ((y = l(a, d.props)), (y.ref = kn(f, a, d)), (y.return = f), y)
  ...
  function v(f, a, d, y, N) {
    return a === null || a.tag !== 7
      ? ((a = zt(d, f.mode, y, N)), (a.return = f), a)
      : ((a = l(a, d)), (a.return = f), a);
  }
  function m(f, a, d) {
  ...
  function p(f, a, d, y) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (Nn(d) || vn(d)) return N !== null ? null : v(f, a, d, y, null);
      wr(f, d);
    }
    return null;
  }
  function E(f, a, d, y, N) {
    ...
    if (typeof y == "object" && y !== null) {
      switch (y.$$typeof) {
        ...
        case lt:
          var C = y._init;
          return E(f, a, d, C(y._payload), N);
      }
      if (Nn(y) || vn(y)) return ((f = f.get(d) || null), v(a, f, y, N, null));
      wr(a, y);
    }
    return null;
  }
  function k(f, a, d, y) {
    for (
      var N = null, C = null, w = a, g = (a = 0), L = null;
      w !== null && g < d.length;
      g++
    ) {
      w.index > g ? ((L = w), (w = null)) : (L = w.sibling);
      var P = p(f, w, d[g], y);
      if (P === null) {
        w === null && (w = L);
        break;
    ...
    if (g === d.length) return (n(f, w), Y && Ct(f, g), N);
    if (w === null) {
      for (; g < d.length; g++)
        ((w = m(f, d[g], y)),
          w !== null &&
    ...
    for (w = r(f, w); g < d.length; g++)
      ((L = E(w, f, g, d[g], y)),
        L !== null &&
          (e && L.alternate !== null && w.delete(L.key === null ? g : L.key),
          (a = o(L, a, g)),
  ...
  function x(f, a, d, y) {
    ...
    for (
      var C = (N = null), w = a, g = (a = 0), L = null, P = d.next();
      w !== null && !P.done;
      g++, P = d.next()
    ) {
      w.index > g ? ((L = w), (w = null)) : (L = w.sibling);
      var D = p(f, w, P.value, y);
      if (D === null) {
        w === null && (w = L);
        break;
      }
    ...
    if (P.done) return (n(f, w), Y && Ct(f, g), N);
    if (w === null) {
      for (; !P.done; g++, P = d.next())
        ((P = m(f, P.value, y)),
          P !== null &&
            ((a = o(P, a, g)),
            C === null ? (N = P) : (C.sibling = P),
    ...
    for (w = r(f, w); !P.done; g++, P = d.next())
      ((P = E(w, f, g, P.value, y)),
        P !== null &&
          (e && P.alternate !== null && w.delete(P.key === null ? g : P.key),
          (a = o(P, a, g)),
          C === null ? (N = P) : (C.sibling = P),
          (C = P)));
    return (
      ...
      switch (d.$$typeof) {
        case sr:
          e: {
            ...
            d.type === Bt
              ? ((a = zt(d.props.children, f.mode, y, d.key)),
                (a.return = f),
                (f = a))
              : ((y = Ir(d.type, d.key, d.props, null, f.mode, y)),
                (y.ref = kn(f, a, d)),
    ...
    return (typeof d == "string" && d !== "") || typeof d == "number"
      ? ((d = "" + d),
        a !== null && a.tag === 6
          ...
          : (n(f, a), (a = Yl(d, f.mode, y)), (a.return = f), (f = a)),
        i(f))
      : n(f, a);
  }
  return I;
        ...
        e: {
          ...
          switch (((p = t), (E = n), x.tag)) {
            ...
            case 0:
              if (
                ((k = x.payload),
                (p = typeof k == "function" ? k.call(E, m, p) : k),
                p == null)
              )
                break e;
              m = J({}, m, p);
...
function yi(e, t) {
  switch ((W(Zn, t), W(Gn, e), W(Qe, or), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
var Rr = nt.ReactCurrentDispatcher,
  Vl = nt.ReactCurrentBatchConfig,
  Mt = 0,
  Z = null,
  te = null,
  re = null,
...
function ki(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Rr.current = e === null || e.memoizedState === null ? ld : od),
    (e = n(r, l)),
    On)
  ) {
    o = 0;
...
function Hl(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do ((o = l.lane), (Z.lanes |= o), (Ot |= o), (l = l.next));
    while (l !== e);
...
function da(e, t) {
  ...
  if (
    ...
    if (
      ((n.flags |= 2048),
      bn(9, ha.bind(null, n, r, l, t), void 0, null),
      le === null)
    )
      throw Error(S(349));
    Mt & 30 || pa(n, t, l);
...
function hl(e, t, n, r) {
  ...
  ((Z.flags |= e), (l.memoizedState = bn(1 | t, n, o, r)));
}
function Cu(e, t) {
...
function Na(e, t, n) {
  return Mt & 21
    ? (Ae(n, t) || ((n = zs()), (Z.lanes |= n), (Ot |= n), (e.baseState = !0)),
      t)
...
function rd(e, t, n) {
  ...
  if (ja(e)) Pa(t, l);
    ...
    ((n = sa(e, t, l, r)),
      n !== null && ((l = pe()), Ue(n, e, r, l), Ta(n, t, r)));
  }
}
function ja(e) {
  var t = e.alternate;
...
var tl = {
  ...
  ld = {
    ...
    useTransition: function () {
      var e = Eu(!1),
        t = e[0];
      return ((e = td.bind(null, e[1])), (Ve().memoizedState = e), [t, e]);
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        bn(9, ha.bind(null, r, o, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  od = {
    ...
    useDeferredValue: function (e) {
      var t = Le();
      return Na(t, te.memoizedState, e);
    },
    useTransition: function () {
      var e = Hl(qn)[0],
        t = Le().memoizedState;
  ...
  id = {
    ...
    useDeferredValue: function (e) {
      var t = Le();
      return te === null ? (t.memoizedState = e) : Na(t, te.memoizedState, e);
    },
    useTransition: function () {
      var e = Wl(qn)[0],
        t = Le().memoizedState;
...
function Po(e, t, n, r) {
  ...
  (typeof o == "object" && o !== null
    ? (l.context = Re(o))
    : ((o = we(t) ? Rt : fe.current), (l.context = on(e, o))),
...
var sd = nt.ReactCurrentOwner,
  ye = !1;
function de(e, t, n, r) {
  t.child = e === null ? ua(t, null, n, r) : sn(t, e.child, n, r);
}
  ...
  return (
    ...
    e !== null && !ye
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        tt(e, t, l))
      : (Y && n && ai(t), (t.flags |= 1), de(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !ye
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        tt(e, t, l))
      : (Y && r && ai(t), (t.flags |= 1), de(e, t, n, l), t.child)
  );
}
function Lu(e, t, n, r, l) {
  ...
  if ((nn(t, l), t.stateNode === null))
    (Mr(e, t), za(t, n, r), Po(t, n, r, l), (r = !0));
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
    ...
    ((i.state = p),
      qr(t, r, i, l),
      (s = t.memoizedState),
      u !== r || p !== s || ge.current || ot
        ? (typeof v == "function" && (jo(t, n, v, r), (s = t.memoizedState)),
          (u = ot || Nu(t, n, u, r, p, s, c))
            ? (m ||
    ...
    u !== m || p !== k || ge.current || ot
      ? (typeof E == "function" && (jo(t, n, E, r), (k = t.memoizedState)),
        (c = ot || Nu(t, n, c, r, p, k, s) || !1)
          ? (v ||
...
function Mu(e, t, n, r, l) {
  return (un(), fi(l), (t.flags |= 256), de(e, t, n, r), t.child);
}
...
function Da(e, t, n) {
  ...
  if (o) {
    ...
    return (
      ...
      u !== null ? (o = yt(u, o)) : ((o = zt(o, i, n, null)), (o.flags |= 2)),
      (o.return = t),
      (r.return = t),
      (r.sibling = o),
      (t.child = r),
...
function ad(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Ql(Error(S(422)))), Sr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (((u = (i & e.childLanes) !== 0), ye || u)) {
    ...
    return (Ri(), (r = Ql(Error(S(421)))), Sr(e, t, i, r));
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((ci(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (gr(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Ie !== null && (Vo(Ie), (Ie = null)))),
        Oo(e, t),
        ae(t),
        null
      );
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Pt(Qe.current)), gr(t))) {
          ((r = t.stateNode), (n = t.type));
          var o = t.memoizedProps;
          switch (((r[He] = t), (r[Xn] = o), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
    ...
    case 6:
      if (e && t.stateNode != null) Ba(e, t, e.memoizedProps, r);
        ...
        if (((n = Pt(Zn.current)), Pt(Qe.current), gr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[He] = t),
        ...
        if (Y && xe !== null && t.mode & 1 && !(t.flags & 128))
          ...
          if (e === null) {
            ...
            (un(),
              ...
              (t.flags |= 4));
          (ae(t), (o = !1));
        } else (Ie !== null && (Vo(Ie), (Ie = null)), (o = !0));
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || G.current & 1 ? ne === 0 && (ne = 3) : Ri())),
    ...
    case 17:
      return (we(t.type) && Kr(), ae(t), null);
    case 19:
      if ((K(G), (o = t.memoizedState), o === null)) return (ae(t), null);
...
function hd(e, t) {
  ...
  for (wo = { focusedElem: e, selectionRange: n }, Vr = !1, j = t; j !== null; )
...
function Va(e) {
  ...
  (t !== null && ((e.alternate = null), Va(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[He], delete t[Xn], delete t[xo], delete t[Zf], delete t[Jf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Wa(e, t, n) {
  ...
  switch (n.tag) {
    ...
    case 22:
      n.mode & 1
        ? ((ce = (r = ce) || n.memoizedState !== null), rt(e, t, n), (ce = r))
        : rt(e, t, n);
      break;
    default:
      rt(e, t, n);
...
function Qa(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      (Me(t, e), Be(e), r & 512 && n !== null && Zt(n, n.return));
      break;
    case 5:
      if (
        (Me(t, e),
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((ce = (c = ce) || v), Me(t, e), (ce = c)) : Me(t, e),
        Be(e),
        r & 8192)
      ) {
        if (
            ...
            ((i = j),
              ...
              i.tag === 22 && i.memoizedState !== null
                ...
                : s !== null
                  ? ((s.return = i), (j = s))
                  : $u(l));
        for (; o !== null; ) ((j = o), Ka(o), (o = o.sibling));
        ((j = l), (kr = u), (ce = c));
      }
      Uu(e);
    } else
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (j = o)) : Uu(e);
  }
}
function Uu(e) {
  for (; j !== null; ) {
...
function Ue(e, t, n, r) {
  if (50 < Dn) throw ((Dn = 0), ($o = null), Error(S(185)));
  (nr(e, n, r),
    (!(A & 2) || e !== le) &&
      (e === le && (!(A & 2) && (yl |= n), ne === 4 && ut(e, ie)),
      Se(e, r),
      n === 1 && A === 0 && !(t.mode & 1) && ((fn = b() + 500), pl && xt())));
}
function Se(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Gi(n), t === 1))
      (e.tag === 0 ? qf(Bu.bind(null, e)) : na(Bu.bind(null, e)),
        Xf(function () {
          !(A & 6) && xt();
        }),
        (n = null));
...
function Ya(e, t) {
  if (((Or = -1), (Fr = 0), A & 6)) throw Error(S(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = ol(e, r);
    ...
    A |= 2;
    var o = Ga();
    (le !== e || ie !== t) && ((Ye = null), (fn = b() + 500), Tt(e, t));
    do
      try {
        wd();
        break;
    ...
    (pi(),
      (nl.current = o),
      (A = l),
      ee !== null ? (t = 0) : ((le = null), (ie = 0), (t = ne)));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((l = po(e)), l !== 0 && ((r = l), (t = Bo(e, l)))), t === 1)
    )
      throw ((n = er), Tt(e, 0), ut(e, r), Se(e, b()), n);
    if (t === 6) ut(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (ut(e, r), (r & 130023424) === r && ((t = Pi + 500 - b()), 10 < t))
          ) {
            if (Br(e, 0) !== 0) break;
            ...
            e.timeoutHandle = ko(Nt.bind(null, e, ve, Ye), t);
            break;
          }
          Nt(e, ve, Ye);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = ko(Nt.bind(null, e, ve, Ye), r);
            break;
          }
          Nt(e, ve, Ye);
          break;
  ...
  return (Se(e, b()), e.callbackNode === n ? Ya.bind(null, e) : null);
}
function Bo(e, t) {
  var n = In;
  return (
...
function Bu(e) {
  ...
  if (n === 1) throw ((n = er), Tt(e, 0), ut(e, t), Se(e, b()), n);
...
function Ti(e, t) {
  ...
  try {
    ...
    ((A = n), A === 0 && ((fn = b() + 500), pl && xt()));
  }
}
function Ft(e) {
  at !== null && at.tag === 0 && !(A & 6) && rn();
  var t = A;
  A |= 1;
  var n = ze.transition,
    r = V;
  try {
    ...
    ((V = r), (ze.transition = n), (A = t), !(A & 6) && xt());
  }
}
function zi() {
  ((ke = Jt.current), K(Jt));
...
function Tt(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), Yf(n)), ee !== null))
...
function Ri() {
  ((ne === 0 || ne === 3 || ne === 2) && (ne = 4),
    le === null || (!(Ot & 268435455) && !(yl & 268435455)) || ut(le, ie));
}
function ol(e, t) {
  var n = A;
  A |= 2;
  var r = Ga();
  (le !== e || ie !== t) && ((Ye = null), Tt(e, t));
  do
    try {
      gd();
      break;
  ...
  while (!0);
  if ((pi(), (A = n), (nl.current = r), ee !== null)) throw Error(S(261));
...
function wd() {
  for (; ee !== null && !Hc(); ) Za(ee);
}
function Za(e) {
  var t = ba(e.alternate, e, ke);
...
function Nt(e, t, n) {
  var r = V,
    l = ze.transition;
  try {
    ((ze.transition = null), (V = 1), Sd(e, t, n, r));
  } finally {
    ((ze.transition = l), (V = r));
  }
  return null;
...
function Sd(e, t, n, r) {
  ...
  if (rl) throw ((rl = !1), (e = Ao), (Ao = null), e);
  return (
    ll & 1 && e.tag !== 0 && rn(),
    (o = e.pendingLanes),
...
function rn() {
  if (at !== null) {
    var e = Rs(ll),
      ...
      n = V;
    try {
      if (((ze.transition = null), (V = 16 > e ? 16 : e), at === null))
        var r = !1;
      else {
        if (((e = at), (at = null), (ll = 0), A & 6)) throw Error(S(331));
        var l = A;
        ...
        if (
          ((A = l), xt(), We && typeof We.onPostCommitFiberRoot == "function")
        )
          try {
...
function kd(e, t, n) {
  ...
  (r !== null && r.delete(t),
    ...
    le === e &&
      (ie & n) === n &&
      (ne === 4 || (ne === 3 && (ie & 130023424) === ie && 500 > b() - Pi)
        ? Tt(e, 0)
        : (ji |= n)),
    Se(e, t));
}
function qa(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var n = pe();
  ((e = et(e, t)), e !== null && (nr(e, t, n), Se(e, n)));
}
function xd(e) {
  var t = e.memoizedState,
    n = 0;
...
ba = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || ge.current) ye = !0;
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return ((ye = !1), cd(e, t, n));
      ye = !!(e.flags & 131072);
    }
  else ((ye = !1), Y && t.flags & 1048576 && ra(t, Gr, t.index));
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      (Mr(e, t), (e = t.pendingProps));
      var l = on(t, fe.current);
      (nn(t, n), (l = ki(null, t, r, e, l, n)));
      var o = xi();
      return (
        (t.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Po(t, r, e, n),
            (t = Ro(null, t, r, !0, o, n)))
          : ((t.tag = 0), Y && o && ai(t), de(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 3:
      e: {
        if ((Ia(t), e === null)) throw Error(S(387));
        ((r = t.pendingProps),
          (o = t.memoizedState),
          (l = o.element),
          aa(e, t),
        ...
        if (((r = i.element), o.isDehydrated))
          if (
            ...
            ((l = cn(Error(S(423)), t)), (t = Mu(e, t, r, n, l)));
            break e;
          } else if (r !== l) {
            ((l = cn(Error(S(424)), t)), (t = Mu(e, t, r, n, l)));
            break e;
          } else
            for (
...
function Ir(e, t, n, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) Li(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case ql:
        return ((e = Te(13, n, t, l)), (e.elementType = ql), (e.lanes = o), e);
      case bl:
        return ((e = Te(19, n, t, l)), (e.elementType = bl), (e.lanes = o), e);
      case cs:
        return gl(n, l, o, t);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (ti(t, n | 1), Se(t, b()), !(A & 6) && ((fn = b() + 500), xt()));
      }
      break;
    case 13:
      (Ft(function () {
...
ks = Ti;
xs = Ft;
var zd = { usingClientEntryPoint: !1, Events: [lr, Qt, dl, ws, Ss, Ti] },
  En = {
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!Er.isDisabled && Er.supportsFiber)
    try {
      ((sl = Er.inject(Rd)), (We = Er));
    } catch {}
}
Ne.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = zd;
...
function Md({
  ...
  const u = z.useRef(null),
    ...
    p = z.useRef(null),
    E = z.useMemo(
      () => `camera-video ${o ? "camera-video-obscured" : ""}`.trim(),
      [o],
    );
  z.useEffect(() => {
    let a;
    async function d() {
      try {
        ((a = await navigator.mediaDevices.getUserMedia({
          ...
          u.current && (u.current.srcObject = a),
          u.current && u.current.play && u.current.play().catch(err => console.warn("autoPlay blocked:", err)));
      } catch (y) {
        (console.error("Camera error:", y),
          m("Không truy cập được webcam. Hãy kiểm tra quyền camera và đảm bảo trang web sử dụng HTTPS hoặc localhost."));
      }
    }
    return (
      d(),
      () => {
        a && a.getTracks().forEach((y) => y.stop());
      }
    );
  }, []);
  const k = [
    ...
    f = (a) => {
      const d = c.current,
        y = u.current;
      if (!d || !y) return;
      const N = y.videoWidth || 640,
        C = y.videoHeight || 480;
      ((d.width = N), (d.height = C));
      const w = d.getContext("2d");
      if ((w.clearRect(0, 0, N, C), !l || !a)) return;
      const g = a.pose_hands,
        L = a.face,
        P = (B) => ({ x: B[0] * N, y: B[1] * C }),
        D = (B) => B && B.length === 2 && B[0] !== 0 && B[1] !== 0,
        $ = (B, O, M, F = 2) => {
          ((w.strokeStyle = M),
            (w.lineWidth = F),
            w.beginPath(),
        ...
        $e = (B, O, M = 2) => {
          ((w.fillStyle = O),
            w.beginPath(),
            w.arc(B.x, B.y, M, 0, Math.PI * 2),
            w.fill());
        };
      if (Array.isArray(L) && L.length >= 468) {
        w.lineWidth = 1;
        for (const [B, O] of I) {
          const M = L[B],
            F = L[O];
          !D(M) || !D(F) || $(P(M), P(F), "rgba(255,255,255,0.2)", 1);
        }
        for (const B of L) D(B) && $e(P(B), "rgba(255,255,255,0.4)", 1);
      }
      ((w.lineCap = "round"), (w.lineJoin = "round"));
      for (const [B, O] of k) {
        const M = g[B],
          F = g[O];
        !D(M) || !D(F) || $(P(M), P(F), "rgba(0, 255, 0, 0.8)", 2);
      }
      for (const [B, O] of x) {
        const M = g[33 + B],
          F = g[33 + O];
        !D(M) || !D(F) || $(P(M), P(F), "rgba(255, 100, 0, 0.8)", 2);
      }
      for (const [B, O] of x) {
        const M = g[54 + B],
          F = g[54 + O];
        !D(M) || !D(F) || $(P(M), P(F), "rgba(0, 100, 255, 0.8)", 2);
      }
      for (const B of g) D(B) && $e(P(B), "rgba(255, 255, 255, 0.9)", 2);
    };
  return (
    z.useEffect(() => {
      var N;
      if (!n || !t) {
        c.current &&
          ((N = c.current.getContext("2d")) == null ||
      ...
      const d = async () => {
          try {
            const C = u.current,
              w = s.current;
            if (!C || !w || C.readyState < 2) return;
            const g = w.getContext("2d");
            ((w.width = C.videoWidth || 640),
              (w.height = C.videoHeight || 480),
              g.drawImage(C, 0, 0, w.width, w.height));
            const L = w.toDataURL("image/jpeg", 0.7),
              P = await fetch(`${e}/predict`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ session_id: t, frame: L }),
              });
            if (!P.ok) return;
            const D = await P.json();
            (typeof r == "function" &&
              r(D.prediction, D.confidence, D.sentence, D.keypoints),
              (p.current = D.keypoints || null),
              f(p.current));
          } catch (C) {
            console.error("predict error", C);
          }
        },
        y = () => {
          (d(), (a = setTimeout(y, 400)));
        };
      return (
        y(),
        () => {
    ...
    h.jsxs("div", {
      ...
      children: [
        v && h.jsx("p", { className: "error camera-error", children: v }),
        h.jsxs("div", {
          className: "camera-wrapper",
          children: [
            h.jsx("button", {
              type: "button",
              className: `camera-quick-toggle ${o ? "active" : ""}`,
              onClick: () => {
                typeof i == "function" && i(!o);
              },
              children: o ? "Blur ON" : "Blur OFF",
            }),
            h.jsx("video", {
              ref: u,
              autoPlay: !0,
            ...
            h.jsx("canvas", { ref: c, className: "camera-overlay" }),
          ],
        }),
        h.jsx("canvas", { ref: s, style: { display: "none" } }),
      ],
    })
  );
}
function Od({ prediction: e, confidence: t, words: n }) {
  const r = e || "—",
    l = Number.isFinite(t) ? Math.max(0, Math.min(1, t)) : 0,
    o = Array.isArray(n) ? n.slice(-6).reverse() : [],
    i = ["↑", "✧", "◌", "✦", "⌁", "✤"],
    u = (o.length > 0 ? o : i).slice(0, 6);
  return h.jsxs("div", {
    className: "prediction-feed",
    children: [
      h.jsxs("div", {
        className: "prediction-live",
        children: [
          h.jsx("div", {
            className: "prediction-live-label",
            children: "Live",
          }),
          h.jsxs("div", {
            className: "prediction-main",
            children: [
              h.jsx("span", { className: "prediction-label", children: r }),
              h.jsxs("span", {
                className: "prediction-conf",
                children: [(l * 100).toFixed(0), "%"],
              }),
            ],
          }),
          h.jsx("div", {
            className: "prediction-bar-outer",
            children: h.jsx("div", {
              className: "prediction-bar-inner",
              style: { width: `${l * 100}%` },
            }),
          }),
        ],
      ...
      h.jsx("div", {
        className: "prediction-symbol-rail",
        children: u.map((s, c) => {
          const v = o.length > 0,
            m = v ? i[c % i.length] : s,
            p = v ? s : "";
...
function Fd({ words: e }) {
  ...
  return h.jsxs("div", {
    ...
    children: [
      h.jsx("h2", { className: "translation-title", children: "Translation" }),
      n ? h.jsx("p", { className: "translation-sentence", children: n }) : null,
    ],
  });
}
function Ku() {
...
function Id(e) {
  const t = e.reduce((l, o) => l + o.length, 0),
    n = new Float32Array(t);
  let r = 0;
  for (const l of e) (n.set(l, r), (r += l.length));
  return n;
}
function Dd(e, t) {
  const n = new ArrayBuffer(44 + e.length * 2),
    r = new DataView(n),
    l = (i, u) => {
      for (let s = 0; s < u.length; s += 1) r.setUint8(i + s, u.charCodeAt(s));
    };
  (l(0, "RIFF"),
    r.setUint32(4, 36 + e.length * 2, !0),
    l(8, "WAVE"),
    l(12, "fmt "),
    r.setUint32(16, 16, !0),
    r.setUint16(20, 1, !0),
    r.setUint16(22, 1, !0),
    r.setUint32(24, t, !0),
    r.setUint32(28, t * 2, !0),
    r.setUint16(32, 2, !0),
    r.setUint16(34, 16, !0),
    l(36, "data"),
    r.setUint32(40, e.length * 2, !0));
  let o = 44;
  for (let i = 0; i < e.length; i += 1) {
    const u = Math.max(-1, Math.min(1, e[i]));
    (r.setInt16(o, u < 0 ? u * 32768 : u * 32767, !0), (o += 2));
  }
...
function Ud(e) {
  return new Promise((t, n) => {
    ...
    ((r.onloadend = () => t(String(r.result || ""))),
      (r.onerror = () => n(new Error("Cannot encode audio blob"))),
      r.readAsDataURL(e));
  });
}
function Ad({ apiBase: e }) {
  const [t, n] = z.useState(!1),
    [r, l] = z.useState("idle"),
    [o, i] = z.useState("Ready"),
    [u, s] = z.useState(""),
    [c, v] = z.useState(""),
    [m, p] = z.useState(""),
    E = z.useRef(null),
    ...
    w = async () => {
      const O = d.current,
        ...
        _ = I.current;
      if (
        (O && (O.disconnect(), (d.current = null)),
        M && (M.disconnect(), (a.current = null)),
        F)
      ) {
        try {
          await F.close();
        } catch (T) {
          console.error("AudioContext close error", T);
        }
        f.current = null;
      }
      _ && (_.getTracks().forEach((T) => T.stop()), (I.current = null));
    },
    g = () => {
      const O = E.current;
      if (((E.current = null), !!O)) {
        ...
        try {
          ...
          console.error("SpeechRecognition stop error", M);
        }
      }
    },
    L = async (O) => {
      const M = await Ud(O),
        F = await fetch(`${e}/speech/transcribe`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ audio_base64: M, language: "auto" }),
        }),
        _ = await F.json();
      if (!F.ok)
        throw new Error(
          (_ == null ? void 0 : _.detail) ||
            `Speech transcribe failed: ${F.status}`,
        );
      const T = String((_ == null ? void 0 : _.text) || "").trim();
      T
        ? (v((R) => (R ? `${R} ${T}` : T)), i("Transcribed"))
        : i("No speech detected");
    },
    P = async () => {
      const O = Ku();
      if (!O) throw new Error("Web Speech API is not available");
      const M = new O();
      ((M.continuous = !0),
        (M.interimResults = !0),
        (M.maxAlternatives = 1),
        (M.onstart = () => {
          i("Listening (realtime)");
        }),
        (M.onresult = (F) => {
          var R;
          const _ = [...k.current];
          let T = "";
          for (let H = F.resultIndex; H < F.results.length; H += 1) {
            const X = String(
              ((R = F.results[H][0]) == null ? void 0 : R.transcript) || "",
            ).trim();
            X && (F.results[H].isFinal ? _.push(X) : (T = `${T} ${X}`.trim()));
          }
          ((k.current = _), v(_.join(" ").trim()), s(T));
        }),
        (M.onerror = (F) => {
          (p(`Mic error: ${F.error || "unknown"}`), i("Mic error"));
        }),
        (M.onend = () => {
          if (x.current)
            try {
              ...
              (console.error("SpeechRecognition restart error", F),
                p("Realtime speech stopped unexpectedly."),
                n(!1),
                (x.current = !1),
                i("Stopped"));
            }
    ...
    D = async () => {
      ...
      if (!M) throw new Error("AudioContext is not supported in this browser");
      const F = new M();
      ((f.current = F), (N.current = F.sampleRate || 16e3));
      const _ = F.createMediaStreamSource(O);
      a.current = _;
      const T = F.createScriptProcessor(4096, 1, 1);
      ((d.current = T),
        (y.current = []),
        (T.onaudioprocess = (R) => {
          const H = R.inputBuffer.getChannelData(0);
          y.current.push(new Float32Array(H));
          const Ut =
            y.current.reduce((Ke, mn) => Ke + mn.length, 0) / N.current;
          s(`Recording... ${Ut.toFixed(1)}s`);
        }),
        _.connect(T),
        T.connect(F.destination),
        i("Recording (backend fallback)"));
    },
    $ = async () => {
      if (!x.current) {
        if ((p(""), s(""), i("Starting..."), (x.current = !0), n(!0), C)) {
          (l("webspeech"), (k.current = c ? [c] : []));
          try {
            await P();
            return;
          } catch (O) {
        ...
        try {
          ...
          (console.error(O),
            p(O.message || "Không thể khởi động mic."),
            n(!1),
            (x.current = !1),
            i("Stopped"),
            l("idle"));
    ...
    $e = async () => {
      if (x.current) {
        if ((n(!1), (x.current = !1), r === "webspeech")) {
          (g(), s(""), i("Stopped"));
          return;
        }
        if (r === "backend") {
          const O = [...y.current];
          if ((await w(), s(""), O.length === 0)) {
            i("No audio captured");
            return;
          }
          try {
            ...
            (console.error(M),
              p(M.message || "Backend speech transcription failed"),
              i("Transcribe error"));
          } finally {
            s("");
          }
    ...
    z.useEffect(
      () => () => {
        ((x.current = !1),
          g(),
          w().catch((O) => {
            console.error("Mic cleanup error", O);
          }));
      },
      [],
    ),
    h.jsxs("div", {
      ...
      children: [
        h.jsxs("div", {
          ...
          children: [
            h.jsx("h3", { className: "mic-title", children: "Mic Input" }),
            h.jsx("span", {
              className: `mic-status ${t ? "on" : "off"}`,
              children: t ? "LIVE" : "IDLE",
            }),
          ],
        }),
        h.jsx("p", {
          ...
          children:
            r === "webspeech"
              ? "Mode: Web Speech API (realtime)"
              : r === "backend"
                ? "Mode: Backend fallback"
                : C
                  ? "Mode: Web Speech available"
                  : "Mode: Backend fallback only",
        }),
        h.jsxs("p", { className: "mic-meta", children: ["Status: ", o] }),
        h.jsxs("div", {
          className: "mic-block",
          children: [
            h.jsx("div", { className: "mic-label", children: "Realtime" }),
            h.jsx("div", {
        ...
        h.jsxs("div", {
          className: "mic-block",
          children: [
            h.jsx("div", { className: "mic-label", children: "Final" }),
            h.jsx("div", {
              className: "mic-content mic-final",
              children: c || "(empty)",
            }),
          ],
        }),
        m ? h.jsx("p", { className: "error mic-error", children: m }) : null,
        h.jsxs("div", {
          className: "mic-actions",
          children: [
            h.jsx("button", {
              type: "button",
              onClick: $,
...
function $d({
  ...
  running: n,
  showSkeleton: r,
  onToggleShowSkeleton: l,
  hideCamera: o,
  onToggleHideCamera: i,
  onConfigChange: u,
}) {
  const [s, c] = z.useState("hybrid"),
    [v, m] = z.useState("spotting"),
    [p, E] = z.useState(0.55),
    [k, x] = z.useState(!0),
    [I, f] = z.useState(!1),
    [a, d] = z.useState(!1),
  ...
  return h.jsxs("div", {
    className: "card",
    children: [
      h.jsx("h2", { children: "Controls" }),
      h.jsxs("div", {
        className: "field",
        children: [
          h.jsx("label", { children: "Model" }),
          h.jsxs("select", {
            value: s,
            onChange: ($) => c($.target.value),
            children: [
              h.jsx("option", { value: "bilstm", children: "BiLSTM" }),
              h.jsx("option", {
                value: "transformer",
                children: "Transformer",
              }),
              h.jsx("option", { value: "stgcn", children: "STGCN" }),
              h.jsx("option", { value: "tcn", children: "TCN" }),
              h.jsx("option", { value: "hybrid", children: "Hybrid" }),
            ],
          }),
        ],
      }),
      h.jsxs("div", {
        className: "field",
        children: [
          h.jsx("label", { children: "Mode" }),
          h.jsxs("select", {
            value: v,
            onChange: ($) => m($.target.value),
            children: [
              h.jsx("option", { value: "sliding", children: "Sliding" }),
              h.jsx("option", { value: "spotting", children: "Spotting" }),
              h.jsx("option", { value: "hybrid", children: "Hybrid" }),
            ],
          }),
        ],
      ...
      h.jsxs("div", {
        ...
        children: [
          h.jsxs("label", {
            children: [
              "Confidence: ",
              h.jsx("strong", { children: p.toFixed(2) }),
            ],
          }),
          h.jsx("input", {
            type: "range",
            ...
            step: "0.01",
            value: p,
            onChange: ($) => E(parseFloat($.target.value)),
          }),
        ],
      }),
      h.jsxs("div", {
          ...
          h.jsxs("label", {
            children: [
              h.jsx("input", {
                ...
                onChange: ($) => {
                  (w($.target.checked),
                    typeof l == "function" && l($.target.checked));
                },
              }),
              "Show skeleton",
            ],
          ...
          h.jsxs("label", {
            children: [
              h.jsx("input", {
                ...
                onChange: ($) => {
                  (L($.target.checked),
                    typeof i == "function" && i($.target.checked));
                },
              }),
              "Blur camera feed",
            ],
      ...
      h.jsxs("div", {
        className: "buttons",
        children: [
          h.jsx("button", { onClick: P, disabled: n, children: "Start" }),
          h.jsx("button", {
            onClick: D,
            className: "secondary",
            disabled: !n,
...
function Bd({ apiBase: e, sessionConfig: t }) {
  var y, N, C, w;
  const [n, r] = z.useState(null),
    [l, o] = z.useState(25),
    [i, u] = z.useState(5),
    [s, c] = z.useState(!1),
    [v, m] = z.useState(""),
    [p, E] = z.useState(null),
    k = z.useRef(null),
    x = z.useMemo(() => (n ? URL.createObjectURL(n) : ""), [n]);
  Pn.useEffect(
    () => () => {
  ...
  const I = (g) => {
      var P;
      const L = ((P = g.target.files) == null ? void 0 : P[0]) || null;
      (r(L), E(null), m(""));
    },
    f = async () => {
      const g = await fetch(`${e}/start-session`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(t),
      });
      if (!g.ok) throw new Error(`Start-session failed: ${g.status}`);
      return (await g.json()).session_id;
    },
    a = async () => {
      if (!n) {
        m("Hãy chọn video trước khi phân tích.");
        return;
      }
      (c(!0), m(""), E(null));
      try {
        const g = await f(),
          L = new FormData();
        (L.append("session_id", g),
          L.append("target_fps", String(l)),
          L.append("stride", String(i)),
          L.append("file", n));
        const P = await fetch(`${e}/upload-video`, { method: "POST", body: L }),
          D = await P.json();
        if (!P.ok)
          throw new Error(
            (D == null ? void 0 : D.detail) || `Upload failed: ${P.status}`,
          );
        E(D);
      } catch (g) {
        m(g.message || "Upload thất bại");
      } finally {
        c(!1);
      }
    },
    d = (g) => {
      k.current &&
        ((k.current.currentTime = g), k.current.play().catch(() => {}));
    };
  return h.jsxs("div", {
    className: "card upload-card",
    children: [
      h.jsx("h2", { children: "Upload Video" }),
      h.jsxs("div", {
        className: "field",
        children: [
          h.jsx("label", { children: "Video file" }),
          h.jsx("input", {
            type: "file",
      ...
      h.jsxs("div", {
        className: "field upload-grid",
        children: [
          h.jsxs("div", {
            children: [
              h.jsx("label", { children: "Target FPS" }),
              h.jsx("input", {
                type: "number",
                min: "1",
                max: "60",
                value: l,
                onChange: (g) =>
                  o(Math.max(1, Math.min(60, Number(g.target.value) || 25))),
                disabled: s,
              }),
            ],
          }),
          h.jsxs("div", {
            children: [
              ...
              h.jsx("input", {
                ...
                value: i,
                onChange: (g) =>
                  u(Math.max(1, Math.min(50, Number(g.target.value) || 5))),
                disabled: s,
              }),
            ],
          }),
      ...
      h.jsx("div", {
        ...
        children: h.jsx("button", {
          onClick: a,
          disabled: s || !n,
          children: s ? "Đang phân tích..." : "Phân tích video",
        }),
      }),
      v && h.jsx("p", { className: "error", children: v }),
      x &&
        h.jsx("div", {
        ...
        h.jsxs("div", {
          ...
          children: [
            h.jsxs("div", {
              ...
              children: [
                h.jsx("h3", { children: "Câu cuối cùng" }),
                h.jsx("p", {
                  className: "sentence-log",
                  children: (p.sentence || []).join(" ") || "(trống)",
                }),
              ],
            }),
            h.jsxs("div", {
              className: "result-block",
              children: [
                h.jsx("h3", { children: "Metadata" }),
                h.jsxs("p", {
                  children: [
                    "Duration: ",
                    (
                      ((y = p.metadata) == null ? void 0 : y.duration_sec) ?? 0
                    ).toFixed(2),
                    "s | Source FPS: ",
                    ((N = p.metadata) == null ? void 0 : N.source_fps) ?? 0,
                    " | Processed frames: ",
                    ((C = p.metadata) == null
                      ? void 0
                      : C.processed_frame_count) ?? 0,
                  ],
                }),
                h.jsxs("p", {
                  children: [
                    "Processing time: ",
                    ((w = p.metadata) == null ? void 0 : w.processing_ms) ?? 0,
                    " ms",
                  ],
                }),
              ],
            ...
            h.jsxs("div", {
              className: "result-block",
              children: [
                h.jsx("h3", { children: "Timeline" }),
                h.jsx("div", {
                  className: "timeline-list",
                  children: (p.timeline || []).map((g, L) =>
                    h.jsxs(
                      "button",
                      {
                        className: "timeline-row",
                        onClick: () => d(g.timestamp_sec),
                        type: "button",
                        children: [
                          h.jsxs("span", {
                            children: [g.timestamp_sec.toFixed(2), "s"],
                          }),
                          h.jsx("span", { children: g.prediction }),
                          h.jsxs("span", {
                            children: [(g.confidence * 100).toFixed(1), "%"],
                          }),
                          h.jsx("span", { children: g.emitted ? "emit" : "-" }),
                        ],
                      },
                      `${g.frame_index}-${L}`,
                    ),
...
function Vd({
  ...
  running: l,
  showSkeleton: o,
  onToggleShowSkeleton: i,
  hideCamera: u,
  onToggleHideCamera: s,
  onConfigChange: c,
  apiBase: v,
  sessionConfig: m,
}) {
  return h.jsxs(h.Fragment, {
    children: [
      h.jsx("div", {
        className: `drawer-backdrop ${e ? "open" : ""}`,
        onClick: t,
        "aria-hidden": !e,
      }),
      h.jsxs("aside", {
        className: `settings-drawer ${e ? "open" : ""}`,
        "aria-hidden": !e,
        children: [
          h.jsxs("div", {
            className: "settings-header",
            children: [
              h.jsx("h2", { children: "Settings" }),
              h.jsx("button", {
                type: "button",
          ...
          h.jsxs("div", {
            ...
            children: [
              ...
              h.jsx(Bd, { apiBase: v, sessionConfig: m }),
            ],
          }),
        ],
      }),
...
const Cr = window.API_BASE || "http://localhost:8000";
function Hd() {
  const [e, t] = z.useState(null),
    ...
    a = async (N) => {
      f(N);
      try {
        const C = await fetch(`${Cr}/start-session`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(N),
        });
        if (!C.ok) throw new Error(`Start-session failed: ${C.status}`);
        const w = await C.json();
        (t(w.session_id), r(!0), o(""), u(0), c([]));
      } catch (C) {
        (console.error(C),
          alert(
            "Không khởi tạo được phiên backend. Hãy kiểm tra server FastAPI.",
          ));
      }
    },
    d = () => {
          ...
          h.jsxs("div", {
            ...
            children: [
              ...
              h.jsxs("button", {
                ...
                children: [
                  "🇫🇷 FRANCE ",
                  h.jsx("span", { className: "nav-caret", children: "▾" }),
                ],
              }),
            ],
          }),
        ...
        children: [
          h.jsx("section", {
            ...
            children: h.jsx(Md, {
              ...
              showSkeleton: v,
              hideCamera: p,
              onToggleHideCamera: E,
            }),
          }),
          h.jsx("section", {
            className: "prediction-column",
            children: h.jsx(Od, { prediction: l, confidence: i, words: s }),
          }),
          h.jsx("section", {
            className: "translation-column",
            children: h.jsxs("div", {
              className: "translation-stack",
              children: [h.jsx(Fd, { words: s }), h.jsx(Ad, { apiBase: Cr })],
            }),
          }),
        ],
      }),
...
Gl.createRoot(document.getElementById("root")).render(
  h.jsx(Pn.StrictMode, { children: h.jsx(Hd, {}) }),
);
